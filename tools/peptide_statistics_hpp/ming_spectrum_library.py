...
class Spectrum:
    ...
    def filter_precursor_peaks(self, tolerance = 20.0):
        # precursor
        new_peaks = filter_precursor_peaks(self.peaks, tolerance, self.mz)
        # precursor + C13
        new_peaks = filter_precursor_peaks(new_peaks, tolerance, self.mz + 1.00335483)
        # precursor - H20
        new_peaks = filter_precursor_peaks(new_peaks, tolerance, self.mz - 18.010564686)
        # precursor - H20 + C13
        new_peaks = filter_precursor_peaks(new_peaks, tolerance, self.mz - 18.010564686 + 1.00335483)
        self.peaks = new_peaks

    def filter_precursor_peaks_all(peaks, tolerance, mz):
        # precursor
        new_peaks = filter_precursor_peaks(peaks, tolerance, mz)
        # precursor + C13
        new_peaks = filter_precursor_peaks(new_peaks, tolerance, mz + 1.00335483)
        # precursor - H20
        new_peaks = filter_precursor_peaks(new_peaks, tolerance, mz - 18.010564686)
        # precursor - H20 + C13
        new_peaks = filter_precursor_peaks(new_peaks, tolerance, mz - 18.010564686 + 1.00335483)
