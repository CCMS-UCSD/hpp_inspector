...
def read_protein_coverage(protein_coverage_file,all_proteins,added_proteins,pep_info,peptide_to_exon_map, nextprot_pe):
    with open(protein_coverage_file) as f:
        ...
        for l in r:
            ...
            gene_unique = l['gene_unique_incl_mismatch'] == 'True'
            sp_matches_saav = int(l['num_proteins_no_tr_incl_mismatch'])
